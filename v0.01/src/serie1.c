...
#define OLEN1 64 // size of serial transmission buffer
volatile unsigned int ostart1; // transmission buffer start index
volatile unsigned int oend1; // transmission buffer end index
volatile char outbuf1[OLEN1]; // storage for transmission buffer

#define ILEN1 64 // size of serial receiving buffer
volatile unsigned int istart1; // receiving buffer start index
volatile unsigned int iend1; // receiving buffer end index
